...
#'@param ratio the threshold for correctness.
#'@param labels The year in which the data was recorded.
#'@param p The year in which the data was recorded.
#'@param m.max The year in which the data was recorded. (Default is infinitive)
#'@param fixedGaps The year in which the data was recorded (Default is NULL).
#'@param fixedEdges The year in which the data was recorded (Default is NULL)b.
