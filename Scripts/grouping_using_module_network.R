...
#'@title convert_to_col_numbers
#'@description Convert group of genes into groups of gene indices.
#'@param modules Modules generated by grouping_using_module_network.
#'@param rawData Raw data that was used in grouping_using_module_network.
#'@return groups of gene indices
