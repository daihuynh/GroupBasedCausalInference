...
epi_gropup_binding_trrust <- validate_internal_TF_mRNA(epi_groups, epi_groups, trrust_db)
...
epi_gropup_binding_encode <- validate_internal_TF_mRNA_by_name_entrezid_database(epi_groups, epi_groups, ENCODE)
epi_gropup_binding_encode

epi_gropup_binding_tred <- validate_internal_TF_mRNA_by_name_entrezid_database(epi_groups, epi_groups, TRED)
epi_gropup_binding_tred
```
...
# 
mes_gropup_binding_trrust <- validate_internal_TF_mRNA(mes_groups, mes_groups, trrust_db)
...
mes_gropup_binding_encode <- validate_internal_TF_mRNA_by_name_entrezid_database(mes_groups, mes_groups, ENCODE)
mes_gropup_binding_encode

mes_gropup_binding_tred <- validate_internal_TF_mRNA_by_name_entrezid_database(mes_groups, mes_groups, TRED)
mes_gropup_binding_tred
```
```